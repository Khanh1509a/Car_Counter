...
while True:
    ...
    imgGraphics = cv2.imread("THAYYPHUU.png", cv2.IMREAD_UNCHANGED)
    ...
    cv2.putText(img, str(len(totalCount)), (255, 100), cv2.FONT_HERSHEY_PLAIN, 9, (50, 50, 255), 8)
